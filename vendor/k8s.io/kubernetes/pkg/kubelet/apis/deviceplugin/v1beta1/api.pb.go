...
type DevicePluginOptions struct {
	...
	// Wheather the Plugin needs use its own scheduler before allocating
	PreAllocateRequired bool `protobuf:"varint,2,opt,name=pre_allocate_required,json=preAllocateRequired,proto3" json:"pre_allocate_required,omitempty"`
	// Indicates if pod annotations are passed to PreAllocate and Allocate call
	PodAnnotationsRequired bool `protobuf:"varint,3,opt,name=pod_annotations_required,json=podAnnotationsRequired,proto3" json:"pod_annotations_required,omitempty"`
}
...
func (m *DevicePluginOptions) GetPreAllocateRequired() bool {
	if m != nil {
		return m.PreAllocateRequired
	}
	return false
}
...
type ListAndWatchResponse struct {
	...
	DevicePluginAnnotation map[string]string `protobuf:"bytes,2,rep,name=DevicePluginAnnotation,json=devicePluginAnnotation" json:"DevicePluginAnnotation,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *ListAndWatchResponse) GetDevicePluginAnnotation() map[string]string {
	if m != nil {
		return m.DevicePluginAnnotation
	}
	return nil
}
...
// - PreAllocate request the devices number to decide which device to allocate
type PreAllocateRequest struct {
	DevicesNum       int64             `protobuf:"varint,1,opt,name=devicesNum,proto3" json:"devicesNum,omitempty"`
	UsableDevicesIDs []string          `protobuf:"bytes,2,rep,name=usableDevicesIDs" json:"usableDevicesIDs,omitempty"`
	PodAnnotation    map[string]string `protobuf:"bytes,3,rep,name=podAnnotation" json:"podAnnotation,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *PreAllocateRequest) Reset()                    { *m = PreAllocateRequest{} }
func (*PreAllocateRequest) ProtoMessage()               {}
func (*PreAllocateRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{7} }

func (m *PreAllocateRequest) GetDevicesNum() int64 {
	if m != nil {
		return m.DevicesNum
	}
	return 0
...
func (m *PreAllocateRequest) GetUsableDevicesIDs() []string {
	if m != nil {
		return m.UsableDevicesIDs
	}
	return nil
}

func (m *PreAllocateRequest) GetPodAnnotation() map[string]string {
	if m != nil {
		return m.PodAnnotation
	}
	return nil
}

// PreAllocate just a list of devices IDs, kubelet will then call Allocate
type PreAllocateResponse struct {
	SelectedDevicesIDs []string `protobuf:"bytes,1,rep,name=selectedDevicesIDs" json:"selectedDevicesIDs,omitempty"`
}

func (m *PreAllocateResponse) Reset()                    { *m = PreAllocateResponse{} }
func (*PreAllocateResponse) ProtoMessage()               {}
func (*PreAllocateResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{8} }

func (m *PreAllocateResponse) GetSelectedDevicesIDs() []string {
	if m != nil {
		return m.SelectedDevicesIDs
	}
	return nil
}
...
func (*AllocateRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{9} }
...
func (*ContainerAllocateRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{10} }
...
func (*AllocateResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{11} }
...
func (*ContainerAllocateResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{12} }
...
func (*Mount) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{13} }
...
func (*DeviceSpec) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{14} }
...
func init() {
	...
	proto.RegisterType((*PreAllocateRequest)(nil), "v1beta1.PreAllocateRequest")
	proto.RegisterType((*PreAllocateResponse)(nil), "v1beta1.PreAllocateResponse")
...
type DevicePluginClient interface {
	...
	// PreAllocate is called, if indicated by Device Plugin during registeration phase,
	// it can do some work like deciding which devices to be allocated on a given Pod
	PreAllocate(ctx context.Context, in *PreAllocateRequest, opts ...grpc.CallOption) (*PreAllocateResponse, error)
}
...
func (c *devicePluginClient) PreAllocate(ctx context.Context, in *PreAllocateRequest, opts ...grpc.CallOption) (*PreAllocateResponse, error) {
	out := new(PreAllocateResponse)
	err := grpc.Invoke(ctx, "/v1beta1.DevicePlugin/PreAllocate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DevicePluginServer interface {
	...
	// PreAllocate is called, if indicated by Device Plugin during registeration phase,
	// it can do some work like deciding which devices to be allocated on a given Pod
	PreAllocate(context.Context, *PreAllocateRequest) (*PreAllocateResponse, error)
}
...
func _DevicePlugin_PreAllocate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PreAllocateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DevicePluginServer).PreAllocate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1beta1.DevicePlugin/PreAllocate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DevicePluginServer).PreAllocate(ctx, req.(*PreAllocateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DevicePlugin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PreAllocate",
			Handler:    _DevicePlugin_PreAllocate_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
...
func (m *ListAndWatchResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DevicePluginAnnotation) > 0 {
		for k := range m.DevicePluginAnnotation {
			dAtA[i] = 0x12
			i++
			v := m.DevicePluginAnnotation[k]
...
func (m *PreAllocateRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PreAllocateRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.DevicesNum != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.DevicesNum))
	}
	if len(m.UsableDevicesIDs) > 0 {
		for _, s := range m.UsableDevicesIDs {
			dAtA[i] = 0x12
			i++
			l = len(s)
			for l >= 1<<7 {
	...
	if len(m.PodAnnotation) > 0 {
		for k := range m.PodAnnotation {
			dAtA[i] = 0x1a
			i++
			v := m.PodAnnotation[k]
			mapSize := 1 + len(k) + sovApi(uint64(len(k))) + 1 + len(v) + sovApi(uint64(len(v)))
...
func (m *PreAllocateResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PreAllocateResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.SelectedDevicesIDs) > 0 {
		for _, s := range m.SelectedDevicesIDs {
			dAtA[i] = 0xa
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *ListAndWatchResponse) Size() (n int) {
	...
	if len(m.DevicePluginAnnotation) > 0 {
		for k, v := range m.DevicePluginAnnotation {
			_ = k
			_ = v
...
func (m *PreAllocateRequest) Size() (n int) {
	var l int
	_ = l
	if m.DevicesNum != 0 {
		n += 1 + sovApi(uint64(m.DevicesNum))
	}
	if len(m.UsableDevicesIDs) > 0 {
		for _, s := range m.UsableDevicesIDs {
			l = len(s)
...
func (m *PreAllocateResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.SelectedDevicesIDs) > 0 {
		for _, s := range m.SelectedDevicesIDs {
...
func (this *DevicePluginOptions) String() string {
	...
	s := strings.Join([]string{`&DevicePluginOptions{`,
		...
		`PreAllocateRequired:` + fmt.Sprintf("%v", this.PreAllocateRequired) + `,`,
...
func (this *ListAndWatchResponse) String() string {
	...
	keysForDevicePluginAnnotation := make([]string, 0, len(this.DevicePluginAnnotation))
	for k := range this.DevicePluginAnnotation {
		keysForDevicePluginAnnotation = append(keysForDevicePluginAnnotation, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForDevicePluginAnnotation)
	mapStringForDevicePluginAnnotation := "map[string]string{"
	for _, k := range keysForDevicePluginAnnotation {
		mapStringForDevicePluginAnnotation += fmt.Sprintf("%v: %v,", k, this.DevicePluginAnnotation[k])
	}
	mapStringForDevicePluginAnnotation += "}"
	s := strings.Join([]string{`&ListAndWatchResponse{`,
		`Devices:` + strings.Replace(fmt.Sprintf("%v", this.Devices), "Device", "Device", 1) + `,`,
		`DevicePluginAnnotation:` + mapStringForDevicePluginAnnotation + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PreAllocateRequest) String() string {
	if this == nil {
		return "nil"
	}
	keysForPodAnnotation := make([]string, 0, len(this.PodAnnotation))
	for k := range this.PodAnnotation {
		keysForPodAnnotation = append(keysForPodAnnotation, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForPodAnnotation)
	mapStringForPodAnnotation := "map[string]string{"
	for _, k := range keysForPodAnnotation {
		mapStringForPodAnnotation += fmt.Sprintf("%v: %v,", k, this.PodAnnotation[k])
	}
	mapStringForPodAnnotation += "}"
	s := strings.Join([]string{`&PreAllocateRequest{`,
		`DevicesNum:` + fmt.Sprintf("%v", this.DevicesNum) + `,`,
		`UsableDevicesIDs:` + fmt.Sprintf("%v", this.UsableDevicesIDs) + `,`,
		`PodAnnotation:` + mapStringForPodAnnotation + `,`,
		`}`,
	}, "")
	return s
}
func (this *PreAllocateResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PreAllocateResponse{`,
		`SelectedDevicesIDs:` + fmt.Sprintf("%v", this.SelectedDevicesIDs) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *DevicePluginOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreAllocateRequired", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PreAllocateRequired = bool(v != 0)
		case 3:
			if wireType != 0 {
...
func (m *ListAndWatchResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DevicePluginAnnotation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DevicePluginAnnotation == nil {
				m.DevicePluginAnnotation = make(map[string]string)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				m.DevicePluginAnnotation[mapkey] = mapvalue
			} else {
				var mapvalue string
				m.DevicePluginAnnotation[mapkey] = mapvalue
			}
...
func (m *PreAllocateRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreAllocateRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreAllocateRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DevicesNum", wireType)
			}
			m.DevicesNum = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DevicesNum |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UsableDevicesIDs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UsableDevicesIDs = append(m.UsableDevicesIDs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PodAnnotation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			mapkey := string(dAtA[iNdEx:postStringIndexmapkey])
			iNdEx = postStringIndexmapkey
			if m.PodAnnotation == nil {
				m.PodAnnotation = make(map[string]string)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := string(dAtA[iNdEx:postStringIndexmapvalue])
				iNdEx = postStringIndexmapvalue
				m.PodAnnotation[mapkey] = mapvalue
			} else {
				var mapvalue string
				m.PodAnnotation[mapkey] = mapvalue
			}
...
func (m *PreAllocateResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreAllocateResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreAllocateResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelectedDevicesIDs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SelectedDevicesIDs = append(m.SelectedDevicesIDs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
...
var fileDescriptorApi = []byte{
	...
	,
}
